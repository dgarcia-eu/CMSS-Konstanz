...
.pull-left[![:scale 100%](Figures/ABM1.svg)]
...
.pull-left[![:scale 100%](Figures/ABM2.svg)]
...
# Important point 1: ABM are explanations
...
# 2: ABM are not empirical evidence
...
## 3: ABM are for analysis, not just exploration
...
- Tutorial sessions from 26.06 can be used to work and get feedback on projects reports and presentations

---

# Course assessment

Students select a published article from a set of readings to present in the second part and to work on a project reviewing the results of the article or working on an extension. 
...
Presentations and reports should show computational insight, for example by reimplementing the model or a (simplified) version of it. Coding language is free choice but I recommend Python.
